...
object Mapping1_19_2 {

    val connection: Field = ServerGamePacketListenerImpl::class.java.getDeclaredField("b").apply { isAccessible = true }
    ...
    val DATA_NO_GRAVITY = getAccessor<Boolean>(Entity::class.java, "aP")
