...
object Mapping1_20_4 {
    ...
    object DISPLAY_MAPPING {
        ...
        val DATA_RIGHT_ROTATION_ID = getAccessor<Quaternionf>(Display::class.java, "aE")
        val DATA_BILLBOARD_RENDER_CONSTRAINTS_ID = getAccessor<Byte>(Display::class.java, "aF")
    }
