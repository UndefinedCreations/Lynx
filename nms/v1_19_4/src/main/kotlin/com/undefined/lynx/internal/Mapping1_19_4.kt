...
object Mapping1_19_4 {
    ...
    object DISPLAY_MAPPING {
        ...
        val DATA_INTERPOLATION_DURATION_ID = getAccessor<Int>(Display::class.java, "r")
        ...
        val DATA_RIGHT_ROTATION_ID = getAccessor<Quaternionf>(Display::class.java, "aC")
        val DATA_BILLBOARD_RENDER_CONSTRAINTS_ID = getAccessor<Byte>(Display::class.java, "aD")

        val DATA_LINE_WIDTH_ID = getAccessor<Int>(Display.TextDisplay::class.java, "aL")
        val DATA_BACKGROUND_COLOR_ID = getAccessor<Int>(Display.TextDisplay::class.java, "aM")
    }
