...
object Mapping1_20_2 {

    val connection: Field = ServerCommonPacketListenerImpl::class.java.getDeclaredField("c").apply { isAccessible = true }
    val latency: Field = ServerCommonPacketListenerImpl::class.java.getDeclaredField("i").apply { isAccessible = true }
    ...
    val DATA_POSE = getAccessor<Pose>(Entity::class.java, "as")
    ...
    object DISPLAY_MAPPING {
        ...
        val DATA_RIGHT_ROTATION_ID = getAccessor<Quaternionf>(Display::class.java, "aF")
        val DATA_BILLBOARD_RENDER_CONSTRAINTS_ID = getAccessor<Byte>(Display::class.java, "aG")
    }
